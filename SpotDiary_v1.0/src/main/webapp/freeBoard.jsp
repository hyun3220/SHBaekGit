...
<link href="https://fonts.googleapis.com/css2?family=Do+Hyeon&display=swap" rel="stylesheet"> 
    ...
    <body id="page-top">
            ...
            <div class="container"><a class="navbar-brand js-scroll-trigger" href="main.jsp">SPOT DIARY</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="main.jsp">홈</a>
                        </li>
    	...
    	<div class = "row">
  		...
  		<a href = "#" class = "btn btn-primary pull-left">글쓰기</a>
  	</div>
  </div>
